...
def DenaryQ():
    ...
    for i in range(random.randint(2,8)):
        denary = random.randint(0,9)
        Denary = Denary.append(denary)
    print(*Denary, sep="")
...
for i in range(qs):
    whichQ = input("binary to denary = 1, hex to denary = 2, denary to binary = 3, denary to hex = 4, hex to binary = 5, binary to hex = 6")
